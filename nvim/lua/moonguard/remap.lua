...
vim.keymap.set("n", "<leader>,fi", [[: -1read $HOME/.config/nvim/snippets/fori.cpp<CR>]])
vim.keymap.set("n", "<leader>,it", [[: -1read $HOME/.config/nvim/snippets/for_iter.cpp<CR>]])
vim.keymap.set("n", "<leader>,at", [[: -1read $HOME/.config/nvim/snippets/autoi.cpp<CR>]])
vim.keymap.set("n", "<leader>,hd", [[: -1read $HOME/.config/nvim/snippets/head.cpp<CR>]])
vim.keymap.set("n", "<leader>,ig", [[: -1read $HOME/.config/nvim/snippets/incguard.cpp<CR>]])
vim.keymap.set("n", "<leader>,wh", [[: -1read $HOME/.config/nvim/snippets/while.cpp<CR>]])
vim.keymap.set("n", "<leader>,fn", [[: -1read $HOME/.config/nvim/snippets/func.cpp<CR>]])
